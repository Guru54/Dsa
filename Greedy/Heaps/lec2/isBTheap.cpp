...
// Checks if the binary tree rooted at 'root' satisfies the max-heap property.
// Returns true if every parent node has a value greater than or equal to its children.
bool isMaxOrder(Node *root)
{
    ...
    if (root->right == NULL)
    {
        // Allow duplicate values in the heap by using >= instead of >
